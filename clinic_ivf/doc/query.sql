...
ALTER TABLE `ivf`.`JobSpecial` 
COMMENT = 'id=267' ;

ALTER TABLE `ivf`.`JobSpecialDetail` 
COMMENT = 'id=268' ;

ALTER TABLE JobSpecialDetail AUTO_INCREMENT = 2680056687;

ALTER TABLE `ivf`.`JobPxDetail` 
CHANGE COLUMN `ID` `ID` BIGINT NOT NULL ,
CHANGE COLUMN `DUID` `DUID` BIGINT NULL DEFAULT NULL ,
CHANGE COLUMN `QTY` `QTY` BIGINT NULL DEFAULT NULL ;
