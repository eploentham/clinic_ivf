...
{
    public class LabFet:Persistent
    {
        public String fet_id { get; set; }
        public String fet_code { get; set; }
        ...
        public String fet_date { get; set; }
        public String freeze_date { get; set; }
        public String freeze_no_of_freeze { get; set; }
        public String freeze_stage_of_freeze { get; set; }
        public String thaw_date { get; set; }
        public String thaw_no_of_thaw { get; set; }
        public String thaw_no_of_survival { get; set; }
        public String thaw_no_of_remaining { get; set; }
        public String media_date { get; set; }
        public String media_lot_no { get; set; }
        public String media_exp { get; set; }
        public String media_thawing { get; set; }
        ...
        public String save_patient_staff_id { get; set; }
        public String save_maturation_staff_id { get; set; }
        public String save_fetilization_staff_id { get; set; }
        public String save_sperm_prepa_staff_id { get; set; }
        public String save_embryo_freezing_day_0_staff_id { get; set; }
        public String save_embryo_freezing_day_1_staff_id { get; set; }
        public String save_embbryo_for_et_staff_id { get; set; }
