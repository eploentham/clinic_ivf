...
namespace clinic_ivf.object1
{
    public class InitConfig
    {
        ...
        public String themeDonor = "",themeDonor1 = "", printerSticker="", printStickerLeft="", printStickerRight = "", printStickerTop = "", printerBill="", printerAppointment="";
        public String timerlabreqaccept = "", timerImgScanNew="", creditCharge="", service_point_id="", statusCheckDonor="";
    }
}
