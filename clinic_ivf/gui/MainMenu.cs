...
namespace clinic_ivf.gui
{
    public partial class MainMenu : Form
    {
        ...
        {
            //throw new NotImplementedException();
            FrmCustomer frm = new FrmCustomer(ic);
            frm.FormBorderStyle = FormBorderStyle.None;
            AddNewTab(frm, menuCust.Text + " ");
        }

        private void MenuStockEndYear_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            FrmStockEndYear frm = new FrmStockEndYear(ic, this);
            frm.FormBorderStyle = FormBorderStyle.None;
            AddNewTab(frm, menuStockEndYear.Text + " ");
        }
        ...
        {
            //throw new NotImplementedException();
            FrmMiscView frm = new FrmMiscView(ic, this);
            frm.FormBorderStyle = FormBorderStyle.None;
            AddNewTab(frm, menuMiscView.Text + " ");
        }

        private void MenuItemMas_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            FrmItem frm = new FrmItem(ic, this);
            frm.FormBorderStyle = FormBorderStyle.None;
            AddNewTab(frm, menuItemMas.Text + " ");
        }
        ...
        private void MainMenu_Load(object sender, EventArgs e)
        {
            ...
            this.Text = ic.iniC.statusAppDonor.Equals("1") ? "โปรแกรมClinic IVF Donor " +"สวัสดี คุณ "+ic.user.staff_fname_t +" "+ic.user.staff_lname_t+" Update 2020-08-28-1 "
                : "โปรแกรมClinic IVF " + "สวัสดี คุณ " + ic.user.staff_fname_t + " " + ic.user.staff_lname_t + " Update 2020-08-28-1 format date " + date;
