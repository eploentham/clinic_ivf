...
namespace clinic_ivf.gui
{
    public partial class MainMenu : Form
    {
        ...
        private void MainMenu_Load(object sender, EventArgs e)
        {
            ...
            this.Text = ic.iniC.statusAppDonor.Equals("1") ? "โปรแกรมClinic IVF Donor " +"สวัสดี คุณ "+ic.user.staff_fname_t +" "+ic.user.staff_lname_t+" Update 2020-03-10 "
                : "โปรแกรมClinic IVF " + "สวัสดี คุณ " + ic.user.staff_fname_t + " " + ic.user.staff_lname_t + " Update 2020-03-10 format date " + date;
